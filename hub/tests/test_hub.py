...
def test_index_serves_advisory_ui(client):
    ...
    for marker in ("view-board", "view-decisions", "view-docs", "view-agents",
                   ...
                   # Pipeline: the dashboard over Routine, owning no records
                   "view-pipeline", "loadPipeline", "renderPipeList", "pipe-seats",
                   "runRoutineFrom", "openRoutineHistory", "live-strip",
                   "startLivePolling", "switchView"):
